module.exports = function readMicrosoftPadding(offset, buffer) {
	/* returns a block of microsoft padding as an array of bytes
		 ...
		 the idea is to add more room to store values in, but in the
		 real world, microsoft padding is usually a gigantic array of null bytes.
